...
Link to the project with the solutions are [here](https://github.com/yaseenagag/promise-it-wont-hurt-solutions)
  - [ ] `src/01-warmup.js`
...
Link to the project with the solutions are [here](https://github.com/yaseenagag/pg-promise-exercises)
